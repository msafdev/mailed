...
StatusFailed.PreviewProps = {
  title: "Something went wrong",
  description:
    "We encountered an issue while processing your request. If the issue persists, please contact our support team.",
  logoImage: `${baseUrl}/static/logo.png`,
  statusImage: `${baseUrl}/static/assets/icon-cross.png`,
  socialItems: [
    {
