      ...
      <Html>
        ...
        <Body className="bg-zinc-200 my-auto mx-auto font-sans p-8 md:p-12">
          <Container className="bg-white border border-solid border-[#eaeaea] rounded-xl mx-auto my-24 max-w-lg">
            ...
            <Heading className="text-black text-xl font-bold text-center m-0 mt-8 mb-4 px-6">
              {title}
            </Heading>
...
BasicWelcome.PreviewProps = {
  title: "Welcome on Board",
  description:
    "We are thrilled to have you join us and are confident that you will be a valuable addition to our organization.",
